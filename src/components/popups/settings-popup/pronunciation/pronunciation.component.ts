...
export class PronunciationComponent extends TabContent {
    ...
    constructor(
        ...
        this.pronounceSwitch.setLabel(i18nKeys.SoundInTrainings);
        this.pronounceWithDoubleClick.setLabel(i18nKeys.PronounceWithDoubleClick);

        this.settings.subscribe(SettingsNames.SoundInTrainings, this.pronounceSwitch.setValue.bind(this.pronounceSwitch));
    ...
    private onPronounceDefaultChange(value: boolean) {
        this.settings.set(SettingsNames.SoundInTrainings, value);
    }
